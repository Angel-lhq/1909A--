...
public class DiscoverRedianAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;

    public DiscoverRedianAdapter(Context context) {
        this.context = context;
    }
    List<DiscoverRedianBean.DataBean.ListBean> list = new ArrayList<>();

    public void setList(List<DiscoverRedianBean.DataBean.ListBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        DiscoverRedianBean.DataBean.ListBean bean = list.get(position);
        ...
        if (getItemViewType(position) == 3) {
            ...
            viewHolder1.rotTvDate.setTextColor(Color.BLACK);
            ...
            viewHolder3.getRotRlv3Tv.setTextColor(Color.BLACK);
        }
    }
    ...
    public int getItemViewType(int position) {
        List<DiscoverRedianBean.DataBean.ListBean.FilePathListBean> filePathList = list.get(position).getFilePathList();
