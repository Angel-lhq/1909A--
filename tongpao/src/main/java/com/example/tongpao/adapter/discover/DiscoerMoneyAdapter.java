...
public class DiscoerMoneyAdapter extends BaseAdapter {
    public DiscoerMoneyAdapter(Context context) {
        super(context);
    }
    ...
    protected void bindData(BaseViewHolder baseViewHolder, Object data) {
        DiscoverRankMoneyBean.DataBean.TongQianTopBean.ListBean bean = (DiscoverRankMoneyBean.DataBean.TongQianTopBean.ListBean) data;
