...
public class DiscoerLevelAdapter extends BaseAdapter {
    public DiscoerLevelAdapter(Context context) {
        super(context);
    }
    ...
    protected void bindData(BaseViewHolder baseViewHolder, Object data) {
        DiscoverranklevelBean.DataBean.ExpTopBean.ListBean bean = (DiscoverranklevelBean.DataBean.ExpTopBean.ListBean) data;
