...
public class DiscoverZhuangzaoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;

    public DiscoverZhuangzaoAdapter(Context context) {
        this.context = context;
    }
    List<DiscoverZhuangzaoBean.DataBean.ListBean> list = new ArrayList<>();

    public void setList(List<DiscoverZhuangzaoBean.DataBean.ListBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        DiscoverZhuangzaoBean.DataBean.ListBean bean = list.get(position);
    ...
    public int getItemViewType(int position) {
        List<DiscoverZhuangzaoBean.DataBean.ListBean.FilePathListBean> filePathList = list.get(position).getFilePathList();
