...
public class InfoPerArticleAdapter extends BaseAdapter<PerArticleBean.DataBean.ArticlesBean> {
    public InfoPerArticleAdapter(Context context) {
        super(context);
    }

    @Override
    protected int getLayout() {
        return R.layout.layout_per_article_item;
    }

    @Override
    protected void bindData(BaseViewHolder holder, PerArticleBean.DataBean.ArticlesBean dataBean) {
